...
MODEL_PATH  = "/Users/yiming/Documents/Sunway/Sem 9/FYP2/Code/career_recommendation/training/models/knn/knn_tfidf_skill_model.pkl"
VECT_PATH   = "/Users/yiming/Documents/Sunway/Sem 9/FYP2/Code/career_recommendation/training/models/knn/tfidf_vectorizer.pkl"
LE_PATH     = "/Users/yiming/Documents/Sunway/Sem 9/FYP2/Code/career_recommendation/training/models/knn/label_encoder.pkl"
...
def recommend_from_resume(resume_text=None, skills_list=None, top_k=TOP_K):
    ...
    if text_col is None:
        ...
        text_col = cand_cols[0] if cand_cols else None
        if not text_col:
            raise RuntimeError("Cannot infer text column from encoded CSV.")
    ...
    if skills_list:
        ...
        raise ValueError("Please provide either `resume_text` or `skills_list`.")
    ...
    if X.shape[1] < expected_features:
        ...
        X = hstack([X, csr_matrix(np.zeros((1, pad)))], format="csr")
    ...
    if hasattr(clf, "predict_proba"):
        ...
        results = [(le.inverse_transform([pred])[0], 1.0)]
