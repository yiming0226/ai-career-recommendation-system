...
# Import career descriptions
from career_descriptions import get_description
...
MODEL_PATH  = "/Users/yiming/Documents/Sunway/Sem 9/FYP2/Code/career_recommendation/training/models/svm/svm_tfidf_skill_model_fixed.pkl"
VECT_PATH   = "/Users/yiming/Documents/Sunway/Sem 9/FYP2/Code/career_recommendation/training/models/svm/tfidf_vectorizer_fixed.pkl"
LE_PATH     = "/Users/yiming/Documents/Sunway/Sem 9/FYP2/Code/career_recommendation/training/models/svm/label_encoder_fixed.pkl"
...
def recommend_from_resume(resume_text=None, skills_list=None, top_k=TOP_K):
    """
    Provide top-k job title recommendations using SVM.
    Either pass `resume_text` or `skills_list`.
    Returns job title, probability, and description for each recommendation.
    """
    ...
    topk_results = []
    for job, prob in zip(topk_labels, topk_probs.round(4)):
    ...
    return {
        ...
        "top_recommendations": topk_results
    }
...
#             for job, prob in result["top_recommendations"]:
#                 print(f"  {job} ({prob})")
#     else:
