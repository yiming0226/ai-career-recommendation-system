"""
train_master_resumes_knn.py

Combines TF-IDF (from Skills_str) + multi-hot skill features,
trains a KNeighborsClassifier and reports top-1/top-3/top-5 accuracy.
...
MODEL_OUTPUT = "/Users/yiming/Documents/Sunway/Sem 9/FYP2/Code/career_recommendation/training/models/knn/knn_tfidf_skill_model.pkl"
VECT_OUTPUT = "/Users/yiming/Documents/Sunway/Sem 9/FYP2/Code/career_recommendation/training/models/knn/tfidf_vectorizer.pkl"
LE_OUTPUT = "/Users/yiming/Documents/Sunway/Sem 9/FYP2/Code/career_recommendation/training/models/knn/label_encoder.pkl"
...
for k in [1, 3, 5]:
    if probs_eval is None:
        ...
        continue
    topk = top_k_accuracy_score(y_eval, probs_eval, k=k, labels=np.arange(len(le.classes_)))
