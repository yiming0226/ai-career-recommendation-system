"""
train_master_resumes_lr.py

Combines TF-IDF (from Skills_str) + multi-hot skill features,
trains a multinomial LogisticRegression (saga solver) and reports
top-1/top-3/top-5 accuracy. Saves model, vectorizer, and label encoder.
"""
...
MODEL_OUTPUT = "/Users/yiming/Documents/Sem 9/FYP2/Code/career_recommendation/training/models/lr/lr_tfidf_skill_model.pkl"
VECT_OUTPUT = "/Users/yiming/Documents/Sem 9/FYP2/Code/career_recommendation/training/models/lr/tfidf_vectorizer.pkl"
LE_OUTPUT = "/Users/yiming/Documents/Sem 9/FYP2/Code/career_recommendation/training/models/lr/label_encoder.pkl"
...
print("⚖️ Training LogisticRegression (multinomial, saga)...")
...
try:
    ...
    print("⚠️ LogisticRegression fit raised an exception (retrying with larger max_iter):", e)
    clf.max_iter = 5000
    clf.fit(X_train, y_train)
